...
public class NeedlemanWunsch{
    ...
    public static void fillDp(DpCell[][] dptable, String A, String B, double delta, double gamma){
        ...
        for(int j = 1; j < m; j++){
            ...
            if (dptable[0][j-1].isFromLeft())
                a = dptable[0][j-1].getValue()-gamma;
            else
        ...
        for(int i = 1; i < n; i++){
            ...
            if(dptable[i-1][0].isFromUp())
                c = dptable[i-1][0].getValue()-gamma;
            else
    ...
    public static void main(String[] args) {
        ...
        fillDp(dptable.getMatrix(), A, B, delta, gamma);
...
class DpCell{
        ...
        public Boolean baseCase(){
            byte set= (byte)3<<3;
            return (((~set) & this.maxCode) == 0)? true : false;
        }
        //urabc
