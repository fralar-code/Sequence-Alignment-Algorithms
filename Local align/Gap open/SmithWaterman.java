...
public class SmithWaterman{
    ...
    public static ArrayList<Coord> fillDp(DpCell[][] dptable, String A, String B, double delta, double T){
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Coord> max_indexes = fillDp(dptable.getMatrix(), A, B, delta, T);
